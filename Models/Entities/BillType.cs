...
{
    [Table("BillTypes", Schema = "Accounting")]
    public partial class BillType : Card
    {
        public BillType()
        {
            Initialize();
        ...
        {
            NotGenerateEntry = true;
            Bills = new HashSet<Bill>();
            //VisitTypeBillTypes = new HashSet<VisitTypeBillType>();
        }
        ...
        //public virtual ICollection<VisitTypeBillType> VisitTypeBillTypes { get; set; }
    }
}
